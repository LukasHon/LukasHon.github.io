...
let buttonvalue = 1;
let hide = document.getElementById("hiddentest");
let cst2 = document.getElementById("cost2");
let up = document.getElementById("ultra");
let hide2 = document.getElementById("hide2");
let cst3 = document.getElementById("cost3");
let omgc = document.getElementById("omega");
let cst4 = document.getElementById("cost4");
let up4 = document.getElementById("buttonupgrade");
let hide3 = document.getElementById("hide3");
let hype = document.getElementById("hype");
let cst5 = document.getElementById("cost5");
/*------------------------------------------------*/
let hide4 = document.getElementById("hide4");
let nukc = document.getElementById("nukee");
let cst6 = document.getElementById("cost6");
let upgbuy2 = false;
let check = false;
let check1 = false;
let check3 = false;
...
let upgbuy = false;
let hiddenoof = false;
let mtl = "you dont have enough clicks for this item: ";
//if (e >= 10) {
